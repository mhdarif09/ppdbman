...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('activity_logs', function (Blueprint $table) {
            ...
            $table->string('action')->comment('Action performed: created, updated, deleted, logged_in, etc.');
            $table->string('model_type')->nullable()->comment('Model class name if applicable');
